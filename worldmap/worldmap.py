...
_df.columns = ['GDP(USD)', 'Average Life', 'Population']
...
item_options = [{'label':x, 'value':x} for x in ['GDP(USD)', 'Average Life', 'Population']]
color_options = [
...
app = DjangoDash('WorldMap', add_bootstrap_links=True)



app.title = "World Statistical map"
app.layout = dbc.Container(
    [
        html.Div([
            html.H4("World Statistical map"),
            html.Div([
                html.P("Data: World bank")
